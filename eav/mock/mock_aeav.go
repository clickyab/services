...
func (m *AKiwi) IncSubKey(key string, value int64) eav.AKiwi {
	t := m.Data[key]
	m.Data[key] = t + value
	return m
}
...
func (m *AKiwi) DecSubKey(key string, value int64) eav.AKiwi {
...
func NewAtomicMockStore(key string) eav.AKiwi {
